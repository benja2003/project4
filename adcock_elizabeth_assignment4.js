...
// Created for: SDI Online Course (SDI-O 1211) : Project 4 / Deliverable 4
// Created on: 11/14/2012

/* Comment:  MAKEUP: Deliverable 3, string function; find the number of hours between two times or days; find the smallest number in an array greater than a given number; Title-case a string; find the total value of just the numbers in an array, even if some of the items are not numbers.
...
// MAIN BODY	
console.log(validationLibrary.phoneNumberCheck ("9042348864"));

console.log(validationLibrary.emailCheck ("elizabethadcock@fullsail.com"));
